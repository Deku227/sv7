CATALOG :
{
    ...
    "url": `https://wa.me/62851567568604
    },
    "businessOwnerJid": "6285156756860@s.whatsapp.net",
    }
    }), { userJid: from, quoted: lep  })
    diablo.relayMessage(num, catalog.message, { messageId: catalog.key.id })
    await sleep(ms(waktu))
    }
    diablobotwhatsapp.reply(`SUKSES KIRIM JAN LUPA JEDANYA OM 3 MENIT KALO NGA JEDA DENDA 5K `)
    }
