...
global.ownerName = 'NET PEDIA'
global.ownerNumber = ["6285156756860@s.whatsapp.net"]
global.packname = '𝙱𝚢'
...
╰━━━╼⃟݊⃟̥⃝̇݊݊⃟  JEDA 3MENIT  ݊⃟̥⃝̇݊⃟╾━━━╯
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
WEBSITE: https://member.net-pedia.site/
...
break
case '4ks':{
diablobotwhatsapp.reply ('Youtube :https://youtube.com/') 
}
break
case 'waifu':
    case 'loli':
...
⭔ Url : ${anu.url}`,
            ...
            break
case 'sc':
diablobotwhatsapp.reply('https://youtube.com/')
break
case 'p':
...
break
case 'akses':
diablobotwhatsapp.reply(`UNTUK AKSES BOT CHAT OWNER : wa.me/62851567568604`)
break
case 'sewa':
diablobotwhatsapp.reply(`UNTUK SEWA BOT CHAT OWNER : wa.me/62851567568604`)
break
case 'join': {
if (!itsMediablo) return diablobotwhatsapp.reply(mess.owner)
